...
def extractAnalysedGames(ratings: list, gamesPerBand: int, timeControls: list, maxPlayerRatingDiff: int = 50, maxRatingDeviation: int = 100, outPath: str = '../out/lichessDB/analysedRating'):
    """
